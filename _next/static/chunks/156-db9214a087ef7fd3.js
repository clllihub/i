    ...
    1379: function(e, t, o) {
        ...
        var i = ["keyOverride"]
          ...
          , c = function(e) {
            ...
            s && d.push(a.createElement("title", {
                key: "title"
            }, s));
            ...
            if (m || u ? (e.dangerouslySetAllPagesToNoIndex && (l.noindex = !0),
            ...
            e.openGraph) {
                ...
                e.openGraph.images && e.openGraph.images.length && d.push.apply(d, h("image", e.openGraph.images, {
                ...
                e.openGraph.videos && e.openGraph.videos.length && d.push.apply(d, h("video", e.openGraph.videos, {
                    defaultWidth: l.defaultOpenGraphVideoWidth,
                    defaultHeight: l.defaultOpenGraphVideoHeight
                })),
                e.openGraph.audio && d.push.apply(d, h("audio", e.openGraph.audio)),
                e.openGraph.locale && d.push(a.createElement("meta", {
                    key: "og:locale",
                    property: "og:locale",
            ...
            e.additionalMetaTags && e.additionalMetaTags.length > 0 && e.additionalMetaTags.forEach(function(e) {
                var t, o, r = e.keyOverride, n = function(e, t) {
                    if (null == e)
                        return {};
                    var o, a, r = {}, n = Object.keys(e);
